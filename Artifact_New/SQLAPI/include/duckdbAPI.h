...
typedef const char* (*duckdb_prepare_error_t)(duckdb_prepared_statement* prepared_statement);
...
typedef void (*duckdb_interrupt_t)(duckdb_connection connection);
...
public:
	...
	duckdb_prepare_error_t duckdb_prepare_error;
	...
	duckdb_interrupt_t duckdb_interrupt;

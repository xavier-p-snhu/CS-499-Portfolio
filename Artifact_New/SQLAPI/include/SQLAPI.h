...
enum eSAClient
{
	...
	SA_MariaDB_Client, //!< MariaDB client
	SA_Client_Last = SA_MariaDB_Client, //!< Special value for enumerations
...
enum eSALibraryErrorType
{
	...
	SA_Library_Error_ConnectionRequired, //!< The function reqires the database connection established
...
public:
	...
	void setCommandText(
		...
		SACommandType_t eCmdType = SA_CmdUnknown //!< The type of the command.
	);
...
public:
	...
	static int GetVersionRevision(); //!< Returns the Library revision version number.
	...
	//! Can be used for the tuning the default long/LOB data writer buffer size.
	static size_t& minDataBufferSize();
...
SQLAPI_API SABool_t sqlapi_field_exists(SACommand* cmd, const SAChar* szField, SAException* err);
